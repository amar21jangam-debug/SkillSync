...
export default function HowItWorks() {
  ...
  return (
    <div ref={ref}>
      <div className="mb-10">
        <div className="text-xs mono uppercase tracking-[0.25em] text-[#FFFFFF] mb-2">How It Works</div>
        <h1 className="text-3xl lg:text-4xl font-semibold tracking-tight">From "I should learn this" to <span className="text-[#FFFFFF]">shipped projects</span>.</h1>
        ...
        {STEPS.map((s) => {
          ...
          return (
            <div key={s.n} data-step className="surface-card p-6 flex gap-4">
              <div className="shrink-0 w-12 h-12 rounded-xl bg-[#FFFFFF]/15 text-[#FFFFFF] border border-[#FFFFFF]/30 flex items-center justify-center">
                <Icon size={22} />
              </div>
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-[10px] mono uppercase tracking-widest text-[#FFFFFF]">Step {s.n}</div>
                </div>
      ...
      <div className="mb-12">
        <div className="text-xs mono uppercase tracking-[0.25em] text-[#FFFFFF] mb-2">Levels & Unlocks</div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-2">
                      {l.perks.map((p) => (
                        <div key={p} className="flex items-start gap-2 text-sm text-[#CCCCCC]">
                          <Check size={14} className="text-[#FFFFFF] shrink-0 mt-0.5" /> {p}
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <div className="surface-card p-8 text-center">
        <div className="text-xs mono uppercase tracking-[0.25em] text-[#FFFFFF] mb-2">Multi-Agent AI</div>
        ...
        <div className="grid sm:grid-cols-3 gap-3 max-w-3xl mx-auto">
          <div className="p-4 rounded-xl bg-[#1F1F1F] border border-[#2A2A2A]">
            <div className="font-semibold text-[#FFFFFF]">Planning</div>
            <div className="text-xs text-[#CCCCCC] mt-1">Milestones & weekly goals</div>
          </div>
          <div className="p-4 rounded-xl bg-[#1F1F1F] border border-[#2A2A2A]">
            <div className="font-semibold text-[#FFFFFF]">Educational</div>
            <div className="text-xs text-[#CCCCCC] mt-1">Concepts, hints, examples</div>
          </div>
          <div className="p-4 rounded-xl bg-[#1F1F1F] border border-[#2A2A2A]">
            <div className="font-semibold text-[#FFFFFF]">Group Support</div>
