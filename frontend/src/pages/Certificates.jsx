    ...
    <div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          <Award size={18} className="text-[#CBFF3D]" />
...
function CertificateCard({ cert, onDownload }) {
  return (
    <div data-cert data-testid={TID.certificateCard(cert.id)} className="surface-card surface-card-hover overflow-hidden">
      <div className="relative p-6 bg-gradient-to-br from-[#CBFF3D]/30 via-[#1F1F1F] to-[#0A0A0A] border-b border-[#CBFF3D]/30">
        <div className="absolute top-3 right-3">
          <Sparkles size={16} className="text-[#CBFF3D]" />
        </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          <div className="text-xs text-[#888]">
            Participation <span className="text-[#CBFF3D] mono font-semibold">{cert.participation}%</span>
          </div>
          <button
