    ...
    <div className="min-h-screen bg-black text-white px-4 py-10 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl">
        <div className="flex items-center gap-2 mb-8">
          <div className="w-8 h-8 rounded-lg bg-[#CBFF3D] flex items-center justify-center">
                ...
                {GOALS.map((g) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-4 rounded-xl border transition-all ${active ? "border-[#FFFFFF] bg-[#FFFFFF]/10 shadow-[0_0_18px_rgba(255,255,255,0.25)]" : "border-[#2A2A2A] bg-[#1F1F1F] hover:border-[#CBFF3D]/40"}`}
                    >
                      <div className="flex items-center gap-3 mb-2">
                        <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${active ? "bg-[#CBFF3D] text-black" : "bg-[#2A2A2A] text-[#CBFF3D]"}`}>
                          <Icon size={18} />
                        </div>
                ...
                {PERSONALITY.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-sm border transition-all ${active ? "bg-[#CBFF3D] text-black border-[#FFFFFF]" : "bg-[#1F1F1F] border-[#2A2A2A] hover:border-[#CBFF3D]/50"}`}
                    >
