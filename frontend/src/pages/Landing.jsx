  ...
  return (
    <div ref={heroRef} className="min-h-screen bg-black text-white">
      ...
      <nav className="sticky top-0 z-30 backdrop-blur-xl bg-black/60 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-[#CBFF3D] flex items-center justify-center glow-white">
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 lg:pt-32 lg:pb-40">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <div className="hero-line inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1F1F1F] border border-[#CBFF3D]/30 text-xs mono uppercase tracking-[0.2em] text-[#CBFF3D] mb-6">
              <Flame size={12} /> Cyber Lab for Devs
            </div>
            <h1 className="hero-line text-5xl sm:text-6xl lg:text-7xl tracking-tight leading-[1.0] mb-6">
              Level up your <em className="text-[#CBFF3D] italic">tech skills</em>,
          ...
          <div className="lg:col-span-5 relative">
            <div className="surface-card p-6 relative overflow-hidden">
              ...
              <div className="mt-5 pt-5 border-t border-[#2A2A2A] flex items-center justify-between text-xs">
                <div className="flex items-center gap-1.5 text-[#CBFF3D]"><Flame size={14} /> 18 day streak</div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="mb-12">
          <div className="text-xs mono uppercase tracking-[0.25em] text-[#CBFF3D] mb-3">Features</div>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight">
            Everything you need to actually <span className="text-[#CBFF3D]">finish</span> what you start.
          </h2>
        </div>
          ...
          {FEATURES.map((f) => {
            ...
            return (
              <div key={f.title} className="feature-card surface-card surface-card-hover p-6">
                <div className="w-10 h-10 rounded-lg bg-[#CBFF3D]/15 text-[#CBFF3D] flex items-center justify-center mb-4">
                  <Icon size={20} />
                </div>
